	...
	useEffect(() => {
        const fetchUsdRate = async () => {
            try {
                ...
                if (rate) {
                    const dollars = RUB_PRICE / rate;
                    const formatted = new Intl.NumberFormat('en-US', { maximumFractionDigits: 0 }).format(dollars);
                    setUsdPrice(formatted);
                }
            } catch (e) {
                console.error('Не удалось загрузить курс USD/RUB с сервера ЦБ РФ:', e);
            }
        };
        ...
        <div className="training-program">
            ...
            <footer className='footer' >
                ...
                <div ref={priceRef} className="mini_card">
                    <h2 className="title">
                        СТОИМОСТЬ <br /> <span>ОБУЧЕНИЯ</span>
                    </h2>
                    <p>
                        Стоимость в<span> $</span> зависит от курса. <br />
                        <span> Актуальная стоимость:</span>
                    </p>
                    <div className="card_detail first_detail">
                        <span className="my_span">в рублях</span>
                        <h3>
                            50.000 <span className="rubl">₽</span>
                        </h3>
                    </div>
                    <div className="card_detail last_detail">
                        <span className="my_span">в долларах</span>
                        <h3>
